		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				...
				<div class="row pb-10">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark"><a href="{{ route('profs.evaluation') }}">{{$evaluationsCount}}</a></div>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{ $ReportCount }}</div>
									<div class="font-14 text-secondary weight-500">
										Reports
									</div>
								</div>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{ $teacherCount }}</div>
									<div class="font-14 text-secondary weight-500">
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{  $modulesCount }}</div>
									<div class="font-14 text-secondary weight-500">Viewing courses</div>
								</div>
								<div class="widget-icon">
						...
						>
							...
							<div class="d-flex justify-content-between align-items-end">
								<div class="text-white">
									<div class="font-14">Go to planning</div>
									<div class="font-24 weight-500">of the year</div>
								</div>
								<div class="max-width-150">
									<div class="text-center mt-2 mr-4">
										<a href={{ route ('profs.calendrie') }} id="custom-btn" class="btn btn-light" target="_blank" style="color:rgb(69, 90, 100); font-size: 24px;">Voir</a>
									</div>
								</div>
							</div>
						</div>
						<div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
							<div class="d-flex justify-content-between pb-20 text-white">
								...
								<div class="font-14 text-right">
									...
									<div class="font-12">Creation date</div>
								</div>
							</div>
							<div class="d-flex justify-content-between align-items-end">
								<div class="text-white">
								...
								<div class="max-width-150">
									<div class="text-center mt-2 mr-4">
										<a href={{ route ('video') }} id="custom-btn" class="btn btn-light" target="_blank" style="color:rgb(38, 94, 215); font-size: 24px;">Voir</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div id="box" class="title pb-20 pt-20">
					<h2 id="text" class="h3 mb-0">There are sites that can help you in your career:</h2>
				</div>
