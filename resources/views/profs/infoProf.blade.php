					...
					<div class="page-header">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="title">
									<h4>professeurs de la filière Transformation Digitale et Intelligence Artificielle</h4>
								</div>
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item">
											<a href={{ route('index2') }} class="ml-4">Accueil</a>
										</li>
										<li class="breadcrumb-item active" aria-current="page">
											Découvrez nos professeurs dévoués qui inspirent et guident nos étudiants vers le succès académique.</ol>
								</nav>
							</div>
						</div>
					</div>
